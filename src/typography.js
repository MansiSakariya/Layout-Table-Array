...
export const Typography = () => {
    return (
        <>
            ...
            <div style={{ marginLeft: "12%", marginRight: "2%",backgroundColor:"#eee",padding:"20px",marginTop:"5%",borderRadius:"10px"  }}>
                <div style={{ backgroundColor: "#AB47BC", borderRadius: "10px ", color: "white", padding: '5px',marginTop:"-70px" }}>
