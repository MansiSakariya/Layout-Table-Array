                        ...
                        <div className="row">
                            <div className="col-sm-4">
                                <div style={{ backgroundColor: "white", borderRadius: "15px", padding: "9px", marginTop: "20%" }}>
                                    <div>
                                        <img style={{ padding: "1%", marginTop: "-80px", borderRadius: "20px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTW05D07aRqnpNnzsu5Fy43yLKG0-FsK9vpXA&usqp=CAU" height="270px" width="510px" />
                                    </div>
                                    <h4>Daily Sales</h4>
                                    <div style={{ display: "flex", gap: "10px" }}>
                            ...
                            <div className="col-sm-4">
                                <div style={{ backgroundColor: "white", borderRadius: "15px", padding: "9px", marginTop: "20%" }}>
                                    <div>
                                        <img style={{ padding: "1%", marginTop: "-80px", borderRadius: "20px" }} src="https://api.backlinko.com/app/uploads/2021/05/substack-paying-subscribers-over-time.png" height="270px" width="510px" />
                                    </div>
                            ...
                            <div className="col-sm-4">
                                <div style={{ backgroundColor: "white", borderRadius: "15px", padding: "9px", marginTop: "20%" }}>
                                    <div>
                                        <img style={{ padding: "1%", marginTop: "-80px", borderRadius: "20px" }} src="https://cdn.labmanager.com/assets/articleNo/29645/aImg/53266/reading-a-bar-chart-versus-a-line-graph-biases-our-judgement-l.jpg" height="270px" width="510px" />
                                    </div>
